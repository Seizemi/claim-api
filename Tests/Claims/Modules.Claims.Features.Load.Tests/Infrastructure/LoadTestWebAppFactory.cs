...
public sealed class LoadTestWebAppFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly PostgreSqlContainer _container = new PostgreSqlBuilder("postgres:17-alpine")
        .WithDatabase("claimapi_load_test")
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        // startup migration once), rather than lazily on the first virtual user's request.
        _ = Server;
    }
