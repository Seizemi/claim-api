...
namespace Modules.Claims.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260921160538_AddClaimEditLock")]
    partial class AddClaimEditLock
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Modules.Claims.Domain.Entities.Claim", b =>
                {
                    ...
                    b.Property<string>("LockedByUserName")
                        ...
                        .HasColumnName("locked_by_user_name");
            ...
            modelBuilder.Entity("Modules.Claims.Domain.Entities.ClaimDate", b =>
                {
                    ...
                    b.HasIndex("DateOfArrival")
                        .HasDatabaseName("ix_claim_dates_date_of_arrival");
